        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                if Workshop.objects.filter(
                    ...
                    return redirect(get_landing_page(user))
        return render(request, 'workshop_app/propose_workshop.html',
                      {"form": form})
...
def workshop_type_details(request, workshop_type_id):
    ...
    if is_instructor(user):
        ...
        return render(request, 'workshop_app/edit_workshop_type.html',
                      {'form': form, 'form_file': form_file})

    return render(request, 'workshop_app/workshop_type_details.html',
...
def add_workshop_type(request):
    ...
    return render(request, 'workshop_app/add_workshop_type.html',
                  {'form': form})
